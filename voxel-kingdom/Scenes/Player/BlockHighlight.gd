...
func _add_edge_box(start_point: Vector3, end_point: Vector3, thickness: float) -> void:
	...
	for face in faces:
		var corner_a: Vector3 = box_corners[face[0]]
		var corner_b: Vector3 = box_corners[face[1]]
		var corner_c: Vector3 = box_corners[face[2]]
		var corner_d: Vector3 = box_corners[face[3]]
		
		_surface_tool.add_vertex(corner_a)
		_surface_tool.add_vertex(corner_b)
		_surface_tool.add_vertex(corner_c)
		
		_surface_tool.add_vertex(corner_a)
		_surface_tool.add_vertex(corner_c)
		_surface_tool.add_vertex(corner_d)
